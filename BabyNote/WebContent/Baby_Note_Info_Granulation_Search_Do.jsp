...
<%
	...
	try{
		...
		String sql = "select * from BABY_NOTE.Info Where I_Category = 'g' and I_Category in (SELECT I_Category FROM BABY_NOTE.Info where I_Subject Like '%"+searchs+"%' OR I_Contents LIKE '%"+searchs+"%')";	
