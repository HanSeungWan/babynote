...
<%
	...
	try{
		...
		String sql = "select * from BABY_NOTE.Info Where I_Category = 'c' and I_Category in (SELECT I_Category FROM BABY_NOTE.Info where I_Subject Like '%"+searchs+"%' OR I_Contents LIKE '%"+searchs+"%')";
...
<!-- 이부분 수정해 주시면 됩니다! 육아 정보 컬럼 검색후 결과 창 입니다. -->
<%
